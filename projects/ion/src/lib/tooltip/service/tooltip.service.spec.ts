...
import { IonTooltipService } from './tooltip.service';
...
let service: IonTooltipService;

const sut = async (): Promise<void> => {
  TestBed.configureTestingModule({
    providers: [IonTooltipService],
  });

  injector = getTestBed();
  service = injector.inject(IonTooltipService);
};

describe('IonTooltipService', () => {
  beforeEach(async () => {
    await sut();
  });
